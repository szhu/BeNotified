...
function PopupUi() {
  const [power, setPower] = useSyncedState(SettingPower);
  ...
  const [showDebugUi, setShowDebugUi] = React.useState(false);
          ...
          El(
            ...
            [
              El("input", {
                ...
                disabled: !apiKey,
                async onChange(e) {
                  await setPower(e.currentTarget.checked);
          ...
          El(...Fieldset, [
            ...
            El(
              "button",
              {
                style: InputStyle,
                async onClick() {
                  chrome.runtime.sendMessage({ type: "send-notification" });
                },
              },
            ...
            El(
              "button",
              {
                ...
                async onClick() {
                  ...
                  setLastCheckError(undefined);
                  setLastMomentId(undefined);
                  setClosedMomentId(undefined);
                },
              },
              ["Reset"],
            ),
